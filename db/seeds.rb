...
Event.create(creator_id: 1, image: "1.jpg", details: "We're going to celebrate the end of angelhack 2015... We are gonna drink some beers!!!", where: "Bogota Beer Company", date: Date.new(2015, 7, 5), time: Time.new(2015, 7, 5, 9, 0, 0))
Event.create(creator_id: 1, image: "2.jpg", details: "One Day Without Shoes! Don't wear shoes...DO IT!", where: "Madison, Tennessee", date: Date.new(2015, 8, 7), time: Time.new(2015, 7, 5, 6, 4, 5))
Event.create(creator_id: 1, image: "3.jpg", details: "fall block party and show!!!!! party starts at 3-6 show @7show is $5 ladies $7 guys comes w/ a complementary CD!! block party is free but game tickets will cost bring extra money… eating contest, prizes, games, free throw contest, pumpkin carving contest, food, haunted house, dunk Rocketown staff Emoticono grin and much more, bring your friends!! click join in!", where: "Rocketown, Nashville, TN", date: Date.new(2015, 8, 6), time: Time.new(2015, 7, 5, 10, 02, 3))
Event.create(creator_id: 1, image: "4.jpg", details: "So few of you asked me about it or were interested in martial arts or I think you'd enjoy it Emoticono smile, so lets set a time and date to come as a group or separate, up to you.", where: "2/54 Crittenden Road, Findon, Adelaide, South Australia 5023", date: Date.new(2015, 8, 23), time: Time.new(2015, 7, 5, 7, 03, 0))
Event.create(creator_id: 2, image: "5.jpg", details: "Food, Friends, Football and Fun! Giant screen TV's, double tap kegerator, keg-vision, potty-vision, etc. Bring a dish to pass and $ for the pools. Please RSVP!", where: "Krohn House, Ladera Ranch, CA", date: Date.new(2015, 10, 26), time: Time.new(2015, 7, 5, 8, 30, 0))
